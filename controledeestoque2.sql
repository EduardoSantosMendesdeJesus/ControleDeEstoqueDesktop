...
( 
	...
	[cli_numeroend]      varchar(20)  NULL ,  /*alterar no banco*/
	[cli_bairro]         varchar(95)  NULL ,
	[cli_cidade]         varchar(95)  NULL , /*alterar no banco*/
	[cli_estado]         varchar(95)  NULL , /*alterar no banco*/
	[cli_telefone]       varchar(95)  NULL ,
	[cli_celular]        varchar(95)  NULL ,
...
( 
	...
	[for_numeroend]      varchar(20)  NULL ,  /*alterar no banco*/
	[for_bairro]         varchar(95)  NULL ,
	[for_cidade]         varchar(95)  NULL ,  /*alterar no banco*/
	[for_estado]         varchar(95)  NULL ,   /*alterar no banco*/
	[for_telefone]       varchar(95)  NULL ,
	[for_celular]        varchar(95)  NULL ,
...
( 
	...
	[tpa_nome]           varchar(95)  NULL   /*alterar no banco*/
)
go
